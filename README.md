...
These scripts are generally intended address a particular scenario and are not typically published as samples of best practices for inclusion in applications.  
